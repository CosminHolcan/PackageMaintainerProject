...
public class PackageVersionServiceImpl implements PackageVersionService{
    ...
    public PackageVersion addPackageVersion(PackageVersion packageVersion) {
        ...
        var versionNumber = packageVersionRepo.existsAllByVersionNumberAndAPackageIs(packageVersion.getVersionNumber(), packageVersion.getAPackage());
    ...
    public List<PackageVersion> getFilteredPackageVersions(Package aPackage) {
        ...
        // var packageVersions = packageVersionRepo.findAllSpecifiedPackageJPQL(aPackage);
        // var packageVersions = packageVersionRepo.findAllSpecifiedPackageJPQL(aPackage);
        // var packageVersions = packageVersionRepo.findAllSpecifiedPackageCriteria(aPackage);
        var packageVersions = packageVersionRepo.findAllSpecifiedPackageSQL(aPackage);
        log.trace("filteredPackageVersions - result={}", packageVersions);
